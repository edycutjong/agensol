<div align="center">
  <img src="docs/assets/readme-hero.png" alt="Agensol Hero" width="100%">
  
  <p><em>AI agent identity registry on SNS. Mint .sol passports. Revoke via transfer.</em></p>
  
  [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen.svg)](https://sns-identity.vercel.app)
  [![Pitch Video](https://img.shields.io/badge/Pitch-Video-red.svg)](https://youtube.com/your-video)
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-sns-identity)
</div>
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-sns-identity.git
   cd frontier-sns-identity
   ```
